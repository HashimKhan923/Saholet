...
<section class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
    <div class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <span class="inline-flex items-center gap-2 rounded-full bg-slate-900 px-3 py-1 text-xs font-semibold text-white dark:bg-slate-100 dark:text-slate-900">{{ $u->isStaff() ? __('admin.dashboard.badge_staff') : __('admin.dashboard.badge') }}</span>
        <h1 class="mt-4 font-display text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white">{{ __('admin.dashboard.welcome', ['name' => $u->name]) }}</h1>
        <p class="mt-2 max-w-prose text-sm leading-relaxed text-slate-600 dark:text-slate-400">{{ __('admin.dashboard.subtitle') }}</p>

        @if ($u->isAdmin())
        <div class="mt-6 grid gap-4 sm:grid-cols-3">
            <div class="rounded-xl bg-slate-50 p-4 dark:bg-slate-800">
                <p class="text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">{{ __('admin.dashboard.approved_providers') }}</p>
            ...
            <a href="{{ route('admin.bookings.index') }}" class="group rounded-xl bg-slate-50 p-4 transition hover:bg-brand-50 dark:bg-slate-800 dark:hover:bg-brand-950/40">
                <p class="text-xs font-semibold uppercase tracking-wide text-slate-500 group-hover:text-brand-700 dark:text-slate-400 dark:group-hover:text-brand-400">{{ __('admin.dashboard.total_bookings') }}</p>
            ...
            <div class="rounded-xl bg-brand-50 p-4 dark:bg-brand-950/40">
                <p class="text-xs font-semibold uppercase tracking-wide text-brand-700 dark:text-brand-400">{{ __('admin.dashboard.commission_earned') }}</p>
    ...
    {{-- Operations --}}
    <h2 class="mt-10 font-display text-sm font-bold uppercase tracking-wide text-slate-900 dark:text-slate-100">{{ __('admin.dashboard.operations_section') }}</h2>
    <div class="mt-3 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
        ...
        <a href="{{ route('admin.categories.index') }}" class="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-brand-200 hover:shadow-md dark:border-slate-800 dark:bg-slate-900 dark:hover:border-brand-800">
            ...
            <h3 class="mt-4 font-display text-base font-bold text-slate-900 dark:text-white">{{ __('admin.dashboard.categories_title') }}</h3>
        ...
        <a href="{{ route('admin.services.index') }}" class="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-brand-200 hover:shadow-md dark:border-slate-800 dark:bg-slate-900 dark:hover:border-brand-800">
            ...
            <h3 class="mt-4 font-display text-base font-bold text-slate-900 dark:text-white">{{ __('admin.dashboard.services_title') }}</h3>
        ...
        <a href="{{ route('admin.providers.index') }}" class="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-brand-200 hover:shadow-md dark:border-slate-800 dark:bg-slate-900 dark:hover:border-brand-800">
            ...
            <h3 class="mt-4 font-display text-base font-bold text-slate-900 dark:text-white">{{ __('admin.dashboard.provider_approvals_title') }}</h3>
        ...
        <a href="{{ route('admin.disputes.index') }}" class="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-brand-200 hover:shadow-md dark:border-slate-800 dark:bg-slate-900 dark:hover:border-brand-800">
            ...
            <h3 class="mt-4 font-display text-base font-bold text-slate-900 dark:text-white">{{ __('admin.dashboard.disputes_title') }}</h3>
    ...
    @if ($showToolsSection)
    {{-- Tools --}}
    <h2 class="mt-10 font-display text-sm font-bold uppercase tracking-wide text-slate-900 dark:text-slate-100">{{ __('admin.dashboard.tools_section') }}</h2>
    <div class="mt-3 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <a href="{{ route('admin.analytics.index') }}" class="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-brand-200 hover:shadow-md dark:border-slate-800 dark:bg-slate-900 dark:hover:border-brand-800">
            ...
            <h3 class="mt-4 font-display text-base font-bold text-slate-900 dark:text-white">{{ __('admin.dashboard.analytics_title') }}</h3>
        ...
        <a href="{{ route('admin.users.index') }}" class="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-brand-200 hover:shadow-md dark:border-slate-800 dark:bg-slate-900 dark:hover:border-brand-800">
            ...
            <h3 class="mt-4 font-display text-base font-bold text-slate-900 dark:text-white">{{ __('admin.dashboard.users_title') }}</h3>
        ...
        <a href="{{ route('admin.service-areas.index') }}" class="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-brand-200 hover:shadow-md dark:border-slate-800 dark:bg-slate-900 dark:hover:border-brand-800">
            ...
            <h3 class="mt-4 font-display text-base font-bold text-slate-900 dark:text-white">{{ __('admin.dashboard.service_areas_title') }}</h3>
