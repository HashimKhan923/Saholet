...
<section class="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-2 flex flex-wrap items-center justify-between gap-3">
        <h1 class="font-display text-2xl font-bold tracking-tight text-slate-900 dark:text-white">{{ $application->jobSeeker->name }}</h1>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <dl class="mt-4 grid gap-x-8 gap-y-3 text-sm sm:grid-cols-2">
                    ...
                    @if ($application->jobSeeker->jobSeekerProfile)
                        ...
                        <div><dt class="text-slate-500 dark:text-slate-400">Age</dt><dd class="font-medium text-slate-800 dark:text-slate-200">{{ $p->age ?? '—' }}</dd></div>
