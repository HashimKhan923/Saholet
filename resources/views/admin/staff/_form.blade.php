    ...
    <div class="lg:col-span-1 space-y-6">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <div class="mt-4">
                ...
                <input id="password" name="password" type="password" @if (! $isEdit) required @endif
            ...
            <div class="mt-4">
                ...
                <input id="password_confirmation" name="password_confirmation" type="password" @if (! $isEdit) required @endif
                    class="mt-1.5 block w-full rounded-lg border border-slate-300 px-3.5 py-2.5 text-sm text-slate-900 shadow-sm outline-none transition focus:border-brand-500 focus:ring-2 focus:ring-brand-200 dark:border-slate-700 dark:bg-slate-950 dark:text-white">
            </div>
        </div>
    </div>
