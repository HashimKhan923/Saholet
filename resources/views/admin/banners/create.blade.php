...
@section('title', 'New banner — ' . config('app.name'))
...
<section class="mx-auto max-w-2xl px-4 py-12 sm:px-6 lg:px-8">
    ...
    <h1 class="mt-1 font-display text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white">New banner</h1>
