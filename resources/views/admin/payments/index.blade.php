...
<section class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
    ...
    <h1 class="mt-1 font-display text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Bank transfer payments</h1>
                ...
                @forelse ($payments as $payment)
                    <tr class="hover:bg-slate-50/60 dark:hover:bg-slate-800/60">
                        ...
                        <td class="px-5 py-3 text-slate-600 dark:text-slate-400">
                            ...
                            <span class="block text-xs text-slate-400 dark:text-slate-500">{{ $payment->created_at->format('h:i A') }}</span>
                        </td>
