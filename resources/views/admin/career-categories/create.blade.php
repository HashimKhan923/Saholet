...
@section('title', 'New career category — ' . config('app.name'))
...
<section class="mx-auto max-w-2xl px-4 py-12 sm:px-6 lg:px-8">
    ...
    <h1 class="mt-1 font-display text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white">New career category</h1>
    ...
    <div class="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 dark:border-slate-800 dark:bg-slate-900">
        @include('admin.career-categories._form', [
            'category' => null,
            'action' => route('admin.career-categories.store'),
            'method' => 'POST',
