...
<section class="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
    ...
    @if ($contract->isQuoted())
        <div class="mt-6 rounded-2xl border border-sky-200 bg-sky-50 p-6 dark:border-sky-900/60 dark:bg-sky-950/30">
            ...
            @endif
            <p class="mt-3 font-display text-2xl font-bold text-sky-900 dark:text-sky-300">Rs. {{ number_format($contract->quoted_total, 0) }}</p>
                    ...
                    <div class="flex flex-wrap items-start justify-between gap-3">
                        ...
                        <div class="text-right">
                            @if ($item->quoted_price)
                                <p class="font-display text-base font-bold text-slate-900 dark:text-white">Rs. {{ number_format($item->quoted_price, 0) }}</p>
                            @endif
