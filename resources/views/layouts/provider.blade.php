...
@section('nav')
    <p class="px-3 text-xs font-display font-bold uppercase tracking-[0.15em] text-slate-900 dark:text-slate-100">{{ __('provider.nav.dashboard_section') }}</p>
    ...
    <p class="mt-5 px-3 text-xs font-display font-bold uppercase tracking-[0.15em] text-slate-900 dark:text-slate-100">{{ __('provider.nav.work_section') }}</p>
    ...
    <p class="mt-5 px-3 text-xs font-display font-bold uppercase tracking-[0.15em] text-slate-900 dark:text-slate-100">{{ __('provider.nav.shop_section') }}</p>
    ...
    <p class="mt-5 px-3 text-xs font-display font-bold uppercase tracking-[0.15em] text-slate-900 dark:text-slate-100">{{ __('provider.nav.shop_settings_section') }}</p>
    <x-portal-nav-link :href="route('provider.shop-settings.profile.edit')" :label="__('provider.nav.shop_profile')" :active="request()->routeIs('provider.shop-settings.profile.*')">
    ...
    <x-portal-nav-link :href="route('provider.shop-settings.shipping.edit')" :label="__('provider.nav.shop_shipping')" :active="request()->routeIs('provider.shop-settings.shipping.*')">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><path d="M20 7l-8-4-8 4m16 0-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </x-portal-nav-link>
    <x-portal-nav-link :href="route('provider.shop-settings.pickup.edit')" :label="__('provider.nav.shop_pickup')" :active="request()->routeIs('provider.shop-settings.pickup.*')">
    ...
    <p class="mt-5 px-3 text-xs font-display font-bold uppercase tracking-[0.15em] text-slate-900 dark:text-slate-100">{{ __('provider.nav.business_section') }}</p>
