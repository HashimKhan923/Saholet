                    ...
                    @if ($canWithdraw)
                        ...
                        <div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4" style="display:none">
                            ...
                            <div class="relative w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl dark:bg-slate-900" @click.outside="open = false">
                                <button type="button" @click="open = false" class="absolute right-4 top-4 cursor-pointer rounded-lg p-1 text-slate-400 transition hover:bg-slate-100 hover:text-slate-600 dark:hover:bg-slate-800 dark:hover:text-slate-200" aria-label="Close">
                                ...
                                <h3 class="pr-6 text-left font-display text-base font-bold text-slate-900 dark:text-white">Withdraw funds</h3>
                                @php
