...
class OrderController extends Controller
{
    ...
    public function show(Order $order): View
    {
        ...
        $order->load(['items.product', 'providerProfile.user', 'events.causedBy', 'payments', 'address', 'coupon', 'reviews.product']);
    ...
    public function cancel(Request $request, Order $order): RedirectResponse
    {
        ...
        return redirect()->route('consumer.orders.show', $order)->with('success', 'Order cancelled.');
    }

    /** Body: product_id, rating, comment?. One review per product per order — see reviewableItems(). */
    public function storeReview(Request $request, Order $order): RedirectResponse
    {
        ...
        return redirect()->route('consumer.orders.show', $order)->with('success', 'Thanks for rating your purchase!');
    }
}
